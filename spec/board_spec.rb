...
module TicTacToe
	describe Board do
		...
		context "#game_over" do
			...
			it "returns :winner when row has objects with values"
				grid = [
    		...
    		it "returns :winner when colum has objects with values" do
    			grid = [
    				[x_cell, x_cell, empty],
    				[y_cell, x_cell, y_cell],
    				[y_cell], x_cell, empty]
    		...
    		it "returns :winner when diagonal has objects with values" do
    			grid = [
    				[x_cell, empty, empty],
    				[y_cell, x_cell, y_cell],
    		...
    		it "returns :draw when all spaces on board are taken" do
    			grid = [
